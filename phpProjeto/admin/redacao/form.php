<?php
  ...
  if(isset($_GET['id'])&& is_numeric($_GET['id'])){
    ...
    // preparação da consulta no back-end
     ...
     // endpoint da API
     $end_point = "http://localhost/api_jornal/redacao/?id=$id";
     ...
     $arrRedacao = $dado["redacao"];
 
     if ($dado['status'] =='success'){
      $nome = $arrRedacao['nome'];
      $salario = $arrRedacao['salario'];
      $telefone = $arrRedacao['telefone'];
      $cpf = $arrRedacao['cpf'];
                ...
                <form action="salvar.php" method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group">  
                      ...
                      <input type="text" id="nome" name="nome" value="<?php echo $nome ?>" class="form-control" placeholder="Nome">
                    </div>
                    <div class="form-group">  
                      <label for="salario">Salário</label>
                      <input type="number" id="salario" name="salario" value="<?php  echo $salario?>" class="form-control" placeholder="Salario" >
                    </div>
                    <div class="form-group">  
                      <label for="telefone">Telefone</label>
                      <input type="text" id="telefone" name="telefone" value="<?php echo $telefone ?>" class="form-control" placeholder="Telefone">
                    </div>
                    <div class="form-group">  
                      <label for="cpf">CPF</label>
                      <input type="text" id="cpf" name="cpf" value="<?php echo $cpf ?>" class="form-control" placeholder="CPF">
                    </div>
