              ...
              <div class="card-body">
                <form action="salvar.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">  
                      <label for="tipo_genero">Tipo_genero</label>
                      <input type="text" id="tipo_genero" name="tipo_genero" value="<?php  echo $tipo_genero?>" class="form-control" placeholder="tipo_genero" >
                    </div>
                  </div>
