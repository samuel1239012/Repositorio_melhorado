<?php
  ...
  if(isset($_GET['id'])&& is_numeric($_GET['id'])){
    ...
    // preparação da consulta no back-end
     ...
     $arrCinema = $dado["cinema"];
 
     if ($dado['status'] =='success'){
      $titulo = $arrCinema['titulo'];
      $sinopse = $arrCinema['sinopse'];
      $elenco = $arrCinema['elenco'];
     }
     if(!empty($arrCinema["imagem"])){
      $img = $comp."../".$arrCinema["imagem"];
    } 
  }
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Inserir Cinema</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <form action="salvar.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">  
                      <label for="cinema">Titulo</label>
                      <input type="text" id="titulo" name="titulo" value="<?php echo $titulo ?>" class="form-control" placeholder="Titulo">
                    </div>
                    <div class="form-group">  
                      <label for="cinema">Sinopse</label>
                      <input type="text" id="sinopse" name="sinopse" value="<?php echo $sinopse ?>" class="form-control" placeholder="Sinopse">
                    </div>
                    <div class="form-group">  
                      <label for="cinema">Elenco</label>
                      <input type="text" id="elenco" name="elenco" value="<?php echo $elenco ?>" class="form-control" placeholder="Elenco">
                    </div>
                    <div class="form-group">  
                    ...
                    <?php if ($img) { ?>
                      ...
                      <input type="file" id="imagem" name="imagem" value="" class="form-control" placeholder="Img Cinema">
                    </div>
